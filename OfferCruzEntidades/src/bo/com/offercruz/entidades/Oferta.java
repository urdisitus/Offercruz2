...
public class Oferta  implements java.io.Serializable {
    ...
    public Oferta(Imagen imagen, Categoria categoria, String descripcion, String nombre, int estado, Date fechaCreacion, Date fechaModificacion, int idEmpresa, int tipoOferta, Double precioUnitario, Set detallecontenidos, Set detallecontenidos_1, Set detallesolicituds) {
       this.imagen = imagen;
       this.categoria = categoria;
       this.descripcion = descripcion;
       this.nombre = nombre;
